            ...
            <div class="row">
                    ...
                    <!-- <span class="count">899</span> 카운트하고 싶으면.. -->
                        <p>
                        	Book Edit
                        	<div id="wrapper">
						        <form action="${path}admin/book/edit/${details.index}" method="post">
						            <fieldset>
						                <legend>Edit Form</legend>
						                <div>
						                    <input type="text" name="title" value="${details.title}" placeholder="책 제목" required/>
						                </div>
						                <div>
						                    <input type="text" name="writer" value="${details.writer}" placeholder="저자" required/>
						                </div>
						                <div>
						                    <input type="text" name="publisher" value="${details.publisher}" placeholder="출판사" required/>
						                </div>
						                <div>
						                    <textarea name="content" placeholder="책 내용" required>${details.content}</textarea>
						                </div>    
						                <div>
						                    <input type="text" name="img" value="${details.img}" placeholder="책 이미지 URL" required/>
						                </div>
						                <div>
